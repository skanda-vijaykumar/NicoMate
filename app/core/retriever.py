...
class CustomRetriever(BaseRetriever):
    ...
    def _retrieve(self, query_bundle: QueryBundle) -> List[NodeWithScore]:
        ...
        if mentioned_families:
            ...
            logging.info(f"Nodes after connector family filter: {len(vector_nodes)} vectors, {len(keyword_nodes)} keywords")
            ...
            if missing_families:
                logging.info(f"Ensuring representation for missing families: {missing_families}")
                # Test sequence
        ...
        if file_type:
            ...
            logging.info(f"Nodes after file type filter: {len(vector_nodes)} vectors, {len(keyword_nodes)} keywords")
