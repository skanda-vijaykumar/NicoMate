...
from llama_index.core import VectorStoreIndex, SimpleKeywordTableIndex, Settings, StorageContext
...
def load_data(directory_path):
    ...
    if not os.path.exists(lab_dir):
        lab_dir = os.path.abspath(os.path.join(directory_path, "..", "extracted_best", "lab"))
...
def process_data(documents1, documents3):
    ...
    try:
        ...
        logging.info(f"Generated {len(nodes_sentencewindow1)} lab sentence window nodes")
